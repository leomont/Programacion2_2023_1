		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					*/
					if(txtname.getText().equals("") || txtApellidos.getText().equals("") || txtcedula.getText().equals("") || txtemail.getText().equals("") || txtDireccionCorrespondencia.getText().equals("") || txtDireccionResidencia.getText().equals("")) {
						...
						*/
						...
						usuario nuevoUsuario = new usuario(txtcedula.getText(), txtname.getText(), txtApellidos.getText(), txtemail.getText(), txtDireccionCorrespondencia.getText(), txtDireccionResidencia.getText());
